let myName: string = "sophia foreman";

console.log("Name: " + myName.toUpperCase());

let myjob: string = "Full Stack Engineer/ Web Development";

console.log("Career: " + myjob);

let description: string = "Young professional working towards career goals in tech.";

console.log("Description: " + description);

console.log(" ")

let interest: string = "My Interests:";
...
let preJobEx: string = "My Previous Experience:"
